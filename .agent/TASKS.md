...
| T-023 | review | codex | `tools/agentctl.py, tests/, README.md, docs/, templates/project/, .agent/` | [.agent/tasks/T-023.md](tasks/T-023.md) | add resumable autonomous loop runtime |
