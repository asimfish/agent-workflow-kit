...
| TA08B0CC413F151F5-027 | review | cursor | `tests/test_execution_lease_workflow.py, tools/agentctl.py, CHANGELOG.md` | [.agent/tasks/TA08B0CC413F151F5-027.md](tasks/TA08B0CC413F151F5-027.md) | harden GPU watchdog regression tests against slow runners; probe supervisor startup race |
