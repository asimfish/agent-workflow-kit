...
- [x] TA08B0CC413F151F5-038 - milestone tasks: a task whose Definition of Done is 'every dependency done', closed by the tool when its children close (owner: cursor)
