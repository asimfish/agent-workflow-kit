...
## Task Board
- [ ] TA08B0CC413F151F5-034 - kit repository: adopt the ledger merge driver (.gitattributes) so its own worktree rebases stop conflicting on the board (owner: cursor)
