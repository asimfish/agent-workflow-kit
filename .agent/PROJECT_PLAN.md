...
## Task Board
- [ ] TA08B0CC413F151F5-030 - post-review hardening: task-id references in commits, Windows CI test list, doctor report for lock records without a resource, docs count (owner: cursor)
