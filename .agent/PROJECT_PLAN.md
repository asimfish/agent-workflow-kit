...
- [ ] TA08B0CC413F151F5-029 - rewrite both READMEs for readability: mental model first, roles in the walkthrough, stuck-state quick reference, status section without the fix log (owner: cursor)
